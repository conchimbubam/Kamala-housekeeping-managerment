...
# Tạo app trực tiếp thay vì dùng factory function
app = Flask(__name__)
...
def export_hk_report():
    ...
    try:
        ...
        # Giả sử bạn có model HousekeepingReport, nếu không cần thay đổi cho phù hợp
        from models.hk_logger import HousekeepingReport
